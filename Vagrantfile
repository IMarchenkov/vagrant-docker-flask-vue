...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision :shell, path: "flask-vuejs-docker/vg-scripts/setup.sh"
  config.vm.provision :shell, path: "flask-vuejs-docker/vg-scripts/startup.sh", run: 'always'
end
